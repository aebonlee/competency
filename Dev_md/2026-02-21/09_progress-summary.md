...
### 세션 11: 결과 페이지 레거시 디자인 완전 재현

| 작업 | 상세 | 커밋 |
|------|------|------|
| Result.jsx 전면 재작성 | 레거시 result.jsp 672줄 디자인 React로 재현 | 세션11 |
| 성별 프로필 카드 | man2.png/woman3.png + 역량별 gradient 오버레이 | 세션11 |
| 8대 역량 카드 | SVG 아이콘 + 원형 배경 + 3단계 크기 (100/80/60px) | 세션11 |
| 3개 차트 탭 | 8대핵심역량(Polar) + 2015교육과정(더블도넛) + NCS(더블도넛) | 세션11 |
